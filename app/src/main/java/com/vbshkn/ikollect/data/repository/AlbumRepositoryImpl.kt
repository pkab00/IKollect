...
class AlbumRepositoryImpl @Inject constructor(
    ...
    override fun getAlbumCandidate(barcode: String): Flow<NetworkResult<AlbumCandidate>> = flow {
    ...
    override fun getEntity(id: Long): Flow<AlbumEntity?> {
    ...
    override fun getFavoriteAlbums(): Flow<NetworkResult<List<AlbumDetails>>> {
    ...
    override fun getAlbumProfile(id: Long): Flow<NetworkResult<AlbumProfileData?>> {
    ...
    override suspend fun updateAlbum(updated: AlbumEntity) {
